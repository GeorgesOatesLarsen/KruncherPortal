...
var Terminator = (function() {
    ...
    Terminator.prototype.writeLine = function(content) {
        ...
        this.lineBreak();
        if (this.bottomBreak) {
            this.bottomBreak.remove();
        }
        this.bottomBreak = document.createElement('br');
        this.element.appendChild(this.bottomBreak);
        return span;
    };
